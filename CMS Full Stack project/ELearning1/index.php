...
?>  
    ...
    <div class="container-fluid" style="margin: 0px; padding: 0px">
      ...
      <div class="vid-content fixed-center" >
        <h1 class="my-content">Welcome to Confiance Club</h1>
        <small class="my-content">Upskill Your Future</small><br/>
        <?php    
              if(!isset($_SESSION['is_login'])){
                echo '<a class="btn btn-danger" href="#" data-toggle="modal" data-target="#stuRegModalCenter">Get Started</a>';
              } else {
                echo '<a class="btn btn-primary" href="student/studentProfile.php">My Profile</a>';
              }
          ?> 
    ...
    <div class="container-fluid bg-dark txt-banner"> <!-- Start Text Banner -->
        <div class="row">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3" style="color:sandybrown;"></i>Courses for Everyone</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-users mr-3" style="color:royalblue;"></i> Expert Instructors</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-user-clock mr-3" style="color:lightpink;"></i>Self-Paced Learning</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-award mr-3" style="color:limegreen;"></i> Quizzes for better Grasp</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    ?>  
     ...
     <div class="container-fluid bg-dark"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          <div class="col-sm">
            <a class="text-white social-hover" href="#"><i class="fab fa-facebook-square" style="color:royalblue"></i> Facebook</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="#"><i class="fab fa-instagram" style="color:#bc2a8d"></i> Instagram</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="#"><i class="fab fa-twitter" style="color:#0096FF"></i> Twitter</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="#"><i class="fab fa-whatsapp" style="color:limegreen"></i> WhatsApp</a>
          </div>
        </div>
      ...
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm text-dark">
            <h5>About Us</h5>
              <p>Confiance provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm text-dark">
            <h5>Category</h5>
          ...
          <div class="col-sm text-dark">
            <h5>Contact Us</h5>
            <p>
                The Confiance Group <br>
               Shree Narayan Complex, Apt. F-1, <br>
               Bajaj Nagar, Central Bazar road, <br> 
               Nagpur, Maharashtra, 440010<br />
               Phone: +919529212169 <br /></p>
          </div>
        </div>
      </div>
